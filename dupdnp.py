...
checksums = {fragment: paths for (size, fragment), paths in fragments.items() if size < 1024 * 1024 + 1}
# remove files already hashed and fragment
fragments = {size: paths for (size, fragment), paths in fragments.items() if size > 1024 * 1024}
